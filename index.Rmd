...
Basé sur un wed de données décrites sémantiquement (web sémantique ou *Linked Open Data*). Les objets numériques sont décrits comme des triples *Resource Description Framework* (RDF) sous la forme: sujet-prédicat-objet (*subject-predicate-object*).

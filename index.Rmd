...
Basée sur l'ouverture de données (*open data*) [décrites sémantiquement](#websem) (*linked open data*), l' *Open Science* repose sur les principes du [FAIR](#FAIR) 
...
Facile à trouver. Repose sur l'attribution d'identifiants uniques (DOI) et un système standardisé de citations: "*How to cite this dataset*", "*How to cite cite this webpage*". Autour des données proprement dites sont construites des métadonnées (*metadata*) elles aussi standardisées
...
Les données sont décrites sous comme des triples sous la forme: sujet-prédicat-objet (*subject-predicate-object*). Ce format de données s'appelle le *Resource Description Framework* (RDF)
